...
fn bindgen_test_layout_nrf_cc310_bl_ecc_public_key_secp256r1_t() {
    const UNINIT: ::core::mem::MaybeUninit<nrf_cc310_bl_ecc_public_key_secp256r1_t> =
...
fn bindgen_test_layout_nrf_cc310_bl_ecc_signature_secp256r1_t() {
    const UNINIT: ::core::mem::MaybeUninit<nrf_cc310_bl_ecc_signature_secp256r1_t> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_nrf_cc310_bl_ecdsa_verify_context_secp256r1_t() {
    const UNINIT: ::core::mem::MaybeUninit<nrf_cc310_bl_ecdsa_verify_context_secp256r1_t> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).init_val) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nrf_cc310_bl_ecdsa_verify_context_secp256r1_t),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).context_buffer) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(nrf_cc310_bl_ecdsa_verify_context_secp256r1_t),
...
fn bindgen_test_layout_nrf_cc310_bl_hash_context_sha256_t() {
    const UNINIT: ::core::mem::MaybeUninit<nrf_cc310_bl_hash_context_sha256_t> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
